	...
	cats: [
		{
			...
			vars: [
				...
				{ id: 'pisa', label: 'Educación (PISA)', dir: 'desc', unit: 'pts', desc: 'mayor = mejor', source: 'OCDE PISA 2022. Promedio de matemáticas, lectura y ciencias. Argelia no participa de PISA — dato estimado por evaluaciones regionales TIMSS.' },
